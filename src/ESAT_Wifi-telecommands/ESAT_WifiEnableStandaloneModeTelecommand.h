...
#ifndef ESAT_WifiEnableStandaloneModeTelecommand_h
#define ESAT_WifiEnableStandaloneModeTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_ENABLE_STANDALONE_MODE.
// Used by ESAT_Wifi.
class ESAT_WifiEnableStandaloneModeTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_WifiEnableStandaloneModeTelecommandClass.
// Used by ESAT_WifiSubsystem.
extern ESAT_WifiEnableStandaloneModeTelecommandClass ESAT_WifiEnableStandaloneModeTelecommand;

#endif /* ESAT_WifiEnableStandaloneModeTelecommand_h */
