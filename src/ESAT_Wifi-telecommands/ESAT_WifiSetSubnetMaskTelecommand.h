...
#ifndef ESAT_WifiSetSubnetMaskTelecommand_h
#define ESAT_WifiSetSubnetMaskTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_SET_SUBNET_MASK.
// Used by ESAT_Wifi.
class ESAT_WifiSetSubnetMaskTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
