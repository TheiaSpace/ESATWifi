...
#ifndef ESAT_WifiSetDomainNameSystemServer1AddressTelecommand_h
#define ESAT_WifiSetDomainNameSystemServer1AddressTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_SET_DOMAIN_NAME_SYSTEM_SERVER_1_ADDRESS.
// Used by ESAT_Wifi.
class ESAT_WifiSetDomainNameSystemServer1AddressTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
