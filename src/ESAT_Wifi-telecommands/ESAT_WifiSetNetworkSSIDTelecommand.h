...
#ifndef ESAT_WifiSetNetworkSSIDTelecommand_h
#define ESAT_WifiSetNetworkSSIDTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_SET_NETWORK_SSID.
// Used by ESAT_Wifi.
class ESAT_WifiSetNetworkSSIDTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the WIFI_SET_NETWORK_SSID telecommand.
    static const byte WIFI_SET_NETWORK_SSID = 0x10;
