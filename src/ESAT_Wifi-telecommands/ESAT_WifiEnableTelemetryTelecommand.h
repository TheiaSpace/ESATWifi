...
#ifndef ESAT_WifiEnableTelemetryTelecommand_h
#define ESAT_WifiEnableTelemetryTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_ENABLE_TELEMETRY.
// Used by ESAT_Wifi.
class ESAT_WifiEnableTelemetryTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
...
// Global instance of ESAT_WifiEnableTelemetryTelecommandClass.
// Used by ESAT_WifiSubsystem.
extern ESAT_WifiEnableTelemetryTelecommandClass ESAT_WifiEnableTelemetryTelecommand;

#endif /* ESAT_WifiEnableTelemetryTelecommand_h */
