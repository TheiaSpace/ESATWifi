...
#ifndef ESAT_WifiSetGatewayAddressTelecommand_h
#define ESAT_WifiSetGatewayAddressTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_SET_GATEWAY_ADDRESS.
// Used by ESAT_Wifi.
class ESAT_WifiSetGatewayAddressTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
