...
#ifndef ESAT_WifiReadConfigurationTelecommand_h
#define ESAT_WifiReadConfigurationTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_READ_CONFIGURATION.
// Used by ESAT_Wifi.
class ESAT_WifiReadConfigurationTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the WIFI_READ_CONFIGURATION telecommand.
    static const byte WIFI_READ_CONFIGURATION = 0x20;
