...
#ifndef ESAT_WifiSetNetworkPassphraseTelecommand_h
#define ESAT_WifiSetNetworkPassphraseTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_SET_NETWORK_PASSPHRASE.
// Used by ESAT_Wifi.
class ESAT_WifiSetNetworkPassphraseTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the WIFI_SET_NETWORK_PASSPHRASE telecommand.
    static const byte WIFI_SET_NETWORK_PASSPHRASE = 0x11;
