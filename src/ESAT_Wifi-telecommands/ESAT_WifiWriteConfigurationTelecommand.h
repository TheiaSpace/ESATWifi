...
// Used by ESAT_Wifi.
class ESAT_WifiWriteConfigurationTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the WIFI_WRITE_CONFIGURATION telecommand.
    static const byte WIFI_WRITE_CONFIGURATION = 0x21;
    ...
    // Handle the telecommand packet (given with the write/write pointer
