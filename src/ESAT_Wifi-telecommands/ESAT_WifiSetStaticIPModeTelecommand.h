...
#ifndef ESAT_WifiSetStaticIPModeTelecommand_h
#define ESAT_WifiSetStaticIPModeTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_SET_STATIC_MODE.
// Used by ESAT_Wifi.
class ESAT_WifiSetStaticIPModeTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
