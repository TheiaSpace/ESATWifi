...
#ifndef ESAT_WifiSetServerAddressTelecommand_h
#define ESAT_WifiSetServerAddressTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_SET_SERVER_ADDRESS.
// Used by ESAT_Wifi.
class ESAT_WifiSetServerAddressTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the WIFI_SET_SERVER_ADDRESS telecommand.
    static const byte WIFI_SET_SERVER_ADDRESS = 0x12;
...
// Global instance of ESAT_WifiSetServerAddressTelecommandClass.
// Used by ESAT_WifiSubsystem.
extern ESAT_WifiSetServerAddressTelecommandClass ESAT_WifiSetServerAddressTelecommand;

#endif /* ESAT_WifiSetServerAddressTelecommand_h */
