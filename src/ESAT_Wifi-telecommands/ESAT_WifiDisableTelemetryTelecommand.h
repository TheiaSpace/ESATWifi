...
#ifndef ESAT_WifiDisableTelemetryTelecommand_h
#define ESAT_WifiDisableTelemetryTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_DISABLE_TELEMETRY.
// Used by ESAT_Wifi.
class ESAT_WifiDisableTelemetryTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
