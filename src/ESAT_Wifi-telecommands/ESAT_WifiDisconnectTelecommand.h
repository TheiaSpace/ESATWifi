...
#ifndef ESAT_WifiDisconnectTelecommand_h
#define ESAT_WifiDisconnectTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_DISCONNECT.
// Used by ESAT_Wifi.
class ESAT_WifiDisconnectTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the WIFI_DISCONNECT telecommand.
    static const byte WIFI_DISCONNECT = 0x01;
