...
#ifndef ESAT_WifiDisableStandaloneModeTelecommand_h
#define ESAT_WifiDisableStandaloneModeTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSTelecommandPacketHandler.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for WIFI_DISABLE_STANDALONE_MODE.
// Used by ESAT_Wifi.
class ESAT_WifiDisableStandaloneModeTelecommandClass: public ESAT_CCSDSTelecommandPacketHandler
{
  public:
